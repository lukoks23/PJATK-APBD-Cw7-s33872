        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abrreviation = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Abrreviation", "FoundationDate", "FullName" },
                values: new object[,]
                {
                    { 1, "cos1", new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Dell" },
                    { 2, "cos2", new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Dell1" },
                    { 3, "cos2", new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Dell2" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "PC1", 20, 2, 5.5 },
                    { 2, new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "PC2", 10, 3, 2.5 },
                    { 3, new DateTime(2020, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "PC3", 3, 1, 8.5 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "0000000000", 1, 1, "Description0", "Component0" },
                    { "0000000001", 2, 2, "Description1", "Component1" },
                    { "0000000002", 1, 2, "Description2", "Component2" }
                });
